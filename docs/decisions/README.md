...
| ADR                                        | Decision                                                                                                                      | Status                        |
| ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| [0001](0001-stack-and-layout.md)           | Monorepo with `packages/core` shared by API and CLI; TypeScript everywhere; Next + shadcn; Express on Railway; Vercel for web | Accepted                      |
