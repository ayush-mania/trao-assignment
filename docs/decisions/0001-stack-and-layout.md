...
Web on Vercel, API on Render (Railway at first; swapped 2026-09-11, same shape). TypeScript everywhere. Dependencies at latest, with two holds:
...
implementation". A shared package makes that structurally true rather than a promise. Render keeps
